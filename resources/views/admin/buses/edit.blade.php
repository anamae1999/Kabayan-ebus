...
<div class="modal fade" id="exampleModalCentereditbus" tabindex="-1" role="dialog" 
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form method="post" action="{{ route('bus.edit') }}" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      <fieldset>
                      <div class="row">
                        <div class="col-md-6">
        ...
        <div class="modal-footer">
         ...
         <a href="edit/{{ $data->bus_id }}"><button type="submit" class="btn btn-primary">Register Bus</button></a>
          </form>
        </div>
      </div>
    </div>
